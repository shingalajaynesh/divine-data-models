...
export class DataModels {
  ...
  setupAssociations() {
    ...
    if (User && StoreOrder) {
      User.hasMany(StoreOrder, { foreignKey: 'userId', as: 'orders' });
