...
export default function init(sequelize) {
  SensoryActivity.init({
    ...
    guidanceEn: { type: DataTypes.TEXT, allowNull: true, field: 'guidance_en' },
    guidanceHi: { type: DataTypes.TEXT, allowNull: true, field: 'guidance_hi' },
    mediaLinks: { type: DataTypes.TEXT, allowNull: true, field: 'media_links' }
  }, {
    sequelize,
